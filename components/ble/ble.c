...
gatts_profile_b_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t * param){
    switch (event) {
        ...
        case ESP_GATTS_READ_EVT: {
            ...
            rsp.attr_value.handle   = param->read.handle;
            rsp.attr_value.len      = 8;
            rsp.attr_value.value[0] = 0x4c;
            rsp.attr_value.value[1] = 0x45;
            rsp.attr_value.value[2] = 0x44;
            rsp.attr_value.value[3] = 0x20;
            rsp.attr_value.value[4] = 0x53;
            rsp.attr_value.value[5] = 0x56;
            rsp.attr_value.value[6] = 0x43;
            esp_ble_gatts_send_response(gatts_if, param->read.conn_id, param->read.trans_id,
              ESP_GATT_OK, &rsp);
            break;
        }
